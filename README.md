...
***Please see [docs.gaois.ie](https://docs.gaois.ie) for the latest documentation in respect of the Logainm API. This repository is no longer being actively maintained. It is retained, however, for archival purposes.***
